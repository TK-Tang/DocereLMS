...
exports.getLeaderboardIncludingExaminables = function(req, res){
    ...
    Models.Leaderboards.getLeaderboardIncludingExaminables(leaderboard_id).then(function(leaderboard){ 
        if(!leaderboard){
